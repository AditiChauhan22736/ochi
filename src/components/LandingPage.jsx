...
function LandingPage() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className='w-full h-screen pt-1'>
          ...
          return (
            <div className="masker" key={index}>
              <div className='w-fit flex items-center overflow-hidden'>
                ...
                <h1 className="uppercase text-[7.5vw] leading-[6.5vw] tracking-tighter font-['Test Founders Grotesk X-Cond SmBd'] font-medium">
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className='border-t-[2px] border-zinc-800 mt-10 flex justify-between items-center py-5 px-20'>
        ...
        <div className="start flex items-center gap-[0.3vw]">
          <button className='px-5 py-1 border-[2px] border-zinc-500 text-[1.1vw] uppercase rounded-full'>
            start the project
          </button>
