...
function Footer() {
  return (
    <div className='w-full h-screen flex p-20 font-["Test Founders Grotesk X-Cond SmBd"]' >
        <div className='w-1/2 h-full'>
        <div className="heading">
        <h1 className='uppercase leading-none -mb-4 -tracking-wider font-bold  text-[7vw]' >eye-</h1>
        <h1 className='uppercase leading-none  -mb-4 -tracking-wider font-bold text-[7vw]'>opening</h1>
        <svg className='mt-80' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2'>
           <h1 className='uppercase leading-none -tracking-wider font-bold  text-[6vw]' >presentations</h1>
        
            <div className='font-semibold capitalize  mt-20'>
               <p class=" text-xl">S:</p>
               <ul className='mt-5'>
                <li><a href="#" className="text-xl" >INSTAGRAM</a></li>
                <li><a href="#" className="text-xl" >BEHANCE</a></li>
                <li><a href="#" className="text-xl" >FACEBOOK</a></li>
            ...
            <div className='font-semibold capitalize mt-20'>
               <p class=" text-xl">E:</p>
               <ul className='mt-5'>
                <li><a href="#" className="text-xl font-light" >hello@ochi.desigh</a></li>
